...
from unet_IH import SuperResModel, UNetModel, EncoderUNetModel, RegressorLinear
...
def regressorLinear_and_diffusion_defaults():
    res = regressorLinear_defaults()
    res.update(diffusion_defaults())
    return res
...
def create_regressorMuRho_and_diffusion(
    image_size,
    in_channels,
    regressor_use_fp16,
    regressor_width,
    ...
    regressor = create_regressorMuRho(
        image_size,
        in_channels,
        regressor_use_fp16,
        regressor_width,
...
def create_regressorLinear_and_diffusion(
    image_size,
    regressor_use_fp16,
    regressor_width,
    regressor_attention_resolutions,
    ...
    regressor = create_RegressorLinear(
    )
    diffusion = create_gaussian_diffusion(
        steps=diffusion_steps,
        learn_sigma=learn_sigma,
...
def create_RegressorLinear(
):
    return RegressorLinear(10

    )

def create_regressorMuRho(
    image_size,
    in_channels,
    regressor_use_fp16,
    regressor_width,
